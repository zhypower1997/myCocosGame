cc.Class({
    ...
    onLoad() {
        ...
        this._setMix(this.animationName[0], this.animationName[1]);
        // 初始化键盘输入监听
    ...
    walk() {
        this.spine.setAnimation(0, this.animationName[0], true);
    },
    idle() {
        this.spine.setAnimation(0, this.animationName[1], true);
    },
    _setMix(anim1, anim2) {
